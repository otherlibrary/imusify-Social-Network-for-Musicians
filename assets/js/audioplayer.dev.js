...
//        console.info(argfind);
    ...
    $.fn.audioplayer = function(o) {
        ...
        this.each(function() {
            ...
            init();
			function setmini(){
				var sid = cthis.attr("data-sid");
				
				var last=$(".mini").attr("data-s");
				$(".mini").removeClass(last).removeClass("loaded skin-wave skin-wave-mode-normal audioplayer");
				$(".mini").html('');
				$(".mini").attr("data-s","s_"+sid);
				$(".mini").addClass("s_"+sid);
				cthis = $(".s_"+sid);
...
//                    img.src= cthis.attr('data-source');
                ...
                cthis.find('.prev-btn').bind('click',click_prev_btn);
                cthis.find('.next-btn').bind('click',click_next_btn);
                cthis.find('.btn-menu-state').bind('click',click_menu_state);
            }
            ...
            function click_comments_bg(e){
                ...
                if(_commentsWriter.hasClass('active')==false){
                    _commentsWriter.css({
                        'height' : _commentsWriter.find('.comments-writer-inner').outerHeight()
                    })
            ...
            function click_submit_comment(e){
                ...
                if(cthis.find('input[name=comment-email]').length>0){
                    ...
                    if(regex_mail.test(cthis.find('input[name=comment-email]').val())==false){
                        alert('please insert email, your email is just used for gravatar. it will not be sent or stored anywhere');
                        return false;
                    }

                    comm_author = String(cthis.find('input[name=comment-email]').val()).split('@')[0];
                    o.skinwave_comments_account = comm_author;
                    //console.info(comm_author);
                    o.skinwave_comments_avatar = 'https://secure.gravatar.com/avatar/'+MD5(String(cthis.find('input[name=comment-email]').val()).toLowerCase())+'?s=20';
                }else{
...
//                        return false;
            ...
            function setup_structure(cthis,dthis){
                //alert('ceva');
				
					
				
				
                dthis.append('<div class="audioplayer-inner"></div>');
				
                _audioplayerInner = cthis.children('.audioplayer-inner');
				_daudioplayerInner =  dthis.children('.audioplayer-inner');
				
                _daudioplayerInner.append('<div class="the-media"></div>');
                _daudioplayerInner.append('<div class="ap-controls"></div>');
				
               /*  _theMedia = _audioplayerInner.children('.the-media').eq(0);
                _apControls = _audioplayerInner.children('.ap-controls').eq(0);  */
				_theMedia = _audioplayerInner.children('.the-media');
				
                _apControls = _audioplayerInner.children('.ap-controls');
                _dapControls = _daudioplayerInner.children('.ap-controls');
                ...
                _dapControls.append(aux);
console.log(dthis.html())
                if(o.disable_timer!='on'){
                    /* _currTime = cthis.find('.curr-time').eq(0);
                    _totalTime = cthis.find('.total-time').eq(0); */
					
					_currTime = dthis.find('.curr-time');
                    _totalTime = dthis.find('.total-time');
                }

                _scrubbar = _apControls.children('.scrubbar');
				_dscrubbar = _dapControls.children('.scrubbar');
                _conControls = _apControls.children('.con-controls');
				_dconControls = _dapControls.children('.con-controls');
                /* _conPlayPause = _conControls.children('.con-playpause').eq(0); */
				_conPlayPause = _conControls.children('.con-playpause');
               
			   _dconControls.append('<div class="controls-volume"><div class="volumeicon"></div><div class="volume_static"></div><div class="volume_active"></div><div class="volume_cut"></div></div>');

                _controlsVolume = _conControls.children('.controls-volume');

                if(cthis.children('.meta-artist').length>0){
                    _daudioplayerInner.append(cthis.children('.meta-artist'));
                }
                /* _audioplayerInner.children('.meta-artist').eq(0).wrap('<div class="meta-artist-con"></div>'); */
				_daudioplayerInner.children('.meta-artist').wrap('<div class="meta-artist-con"></div>');
                
				
				/* _metaArtistCon = _audioplayerInner.children('.meta-artist-con').eq(0); */
				_metaArtistCon = _audioplayerInner.children('.meta-artist-con');
                ...
                if(cthis.attr('data-thumb')!=undefined && cthis.attr('data-thumb')!=''){
                    _daudioplayerInner.prepend('<div class="the-thumb-con"><div class="the-thumb" style="'+str_thumbh+' background-image:url('+cthis.attr('data-thumb')+')"></div></div>');
                    /* _theThumbCon = _audioplayerInner.children('.the-thumb-con').eq(0); */
					_theThumbCon = _daudioplayerInner.children('.the-thumb-con');
//                    console.info(cthis, cthis.attr('data-thumb_link'));
                ...
                if(o.design_skin=='skin-wave'){
                    ...
                    if(o.skinwave_enableSpectrum!='on'){
                        if(cthis.attr('data-scrubbg')!=undefined){
							...
							_dscrubbar.children('.scrub-bg').append('<img class="scrub-bg-img" src="'+cthis.attr('data-scrubbg')+'"/>');
                        }
                        if(cthis.attr('data-scrubprog')!=undefined){
							...
							_dscrubbar.children('.scrub-prog').append('<img class="scrub-prog-img" src="'+cthis.attr('data-scrubprog')+'"/>');
                        }
                       /*  _scrubbar.find('.scrub-bg-img').eq(0).css({
                            'width' : _scrubbar.children('.scrub-bg').width()
                        }); */
						_dscrubbar.find('.scrub-bg-img').css({
                            'width' : _dscrubbar.children('.scrub-bg').width()
                        });
						...
						_dscrubbar.find('.scrub-prog-img').css({
                            'width' : _dscrubbar.children('.scrub-bg').width()
                        });
                        ...
                        if(o.skinwave_enableReflect=='on'){
                           /*  _scrubbar.children('.scrub-bg-reflect').eq(0).append('<img class="scrub-bg-img-reflect" src="'+cthis.attr('data-scrubbg')+'"/>'); */
							 _dscrubbar.children('.scrub-bg-reflect').append('<img class="scrub-bg-img-reflect" src="'+cthis.attr('data-scrubbg')+'"/>');
                            if(cthis.attr('data-scrubprog')!=undefined){
                               /*  _scrubbar.children('.scrub-prog-reflect').eq(0).append('<img class="scrub-prog-img-reflect" src="'+cthis.attr('data-scrubprog')+'"/>'); */
							    _dscrubbar.children('.scrub-prog-reflect').append('<img class="scrub-prog-img-reflect" src="'+cthis.attr('data-scrubprog')+'"/>');
                            }
                       ...
                       /*  _scrubbar.children('.scrub-bg').eq(0).append('<canvas class="scrub-bg-canvas" style="width: 100%; height: 100%;"></canvas><div class="wave-separator"></div>');
						...
						_dscrubbar.children('.scrub-bg').append('<canvas class="scrub-bg-canvas" style="width: 100%; height: 100%;"></canvas><div class="wave-separator"></div>');
                        _dscrubBgCanvas = cthis.find('.scrub-bg-canvas');
						
                        _dscrubBgCanvasCtx = _scrubBgCanvas.get(0).getContext("2d");
                        ...
                        _dscrubBgCanvas = cthis.find('.scrub-bg-canvas');
                            ...
                            _dscrubProgCanvasCtx = _scrubProgCanvas.get(0).getContext("2d");
                        }
                        ...
                        if(o.skinwave_enableReflect=='on'){
							...
							_dscrubbar.children('.scrub-bg-reflect').append('<canvas class="scrub-bg-canvas-reflect" style="width: 100%; height: 100%;"></canvas>');
                            _dscrubBgReflectCanvas = _scrubbar.find('.scrub-bg-canvas-reflect');
							
                            _dscrubBgReflectCtx = _scrubBgReflectCanvas.get(0).getContext("2d");
                            ...
                            if(type=='audio'){
                               /*  _scrubbar.children('.scrub-prog-reflect').eq(0).append('<canvas class="scrub-prog-canvas-reflect" style="width: 100%; height: 100%;"></canvas>');
                                ...
                                _scrubProgCanvasReflect = _scrubbar.find('.scrub-prog-canvas-reflect').eq(0); */
								 ...
								 _dscrubbar.children('.scrub-prog-reflect').append('<canvas class="scrub-prog-canvas-reflect" style="width: 100%; height: 100%;"></canvas>');

                                _scrubProgCanvasReflect = _dscrubbar.find('.scrub-prog-canvas-reflect');
                ...
                if(dthis.hasClass('skin-minimal')){
                   /*  _conPlayPause.children('.playbtn').append('<canvas width="100" height="100" class="playbtn-canvas"/>');
                    ...
                    skin_minimal_canvaspause = _conPlayPause.find('.pausebtn-canvas').eq(0).get(0); */
					 _conPlayPause.children('.playbtn').append('<canvas width="100" height="100" class="playbtn-canvas"/>');
                    skin_minimal_canvasplay = _conPlayPause.find('.playbtn-canvas').get(0);
                    _conPlayPause.children('.pausebtn').append('<canvas width="100" height="100" class="pausebtn-canvas"/>');
                    skin_minimal_canvaspause = _conPlayPause.find('.pausebtn-canvas').get(0);
                }
...
//                        console.info(cthis.attr('data-source'));
            ...
            function setup_listeners(){
                ...
                _conControls.find('.con-playpause').bind('click', click_playpause);
...
//                        console.info(o.design_skin, _currTime,  _metaArtistCon, _metaArtistCon.css('left'), parseInt(_metaArtistCon.css('left'),10), parseInt(_metaArtistCon.css('left'),10) + _metaArtistCon_w + 10);
            ...
            function play_media(){
                //console.log()
				//setup_structure_mini();
				var minis=$(".mini").attr("data-s")
				var cs="s_"+cthis.attr('data-sid');
				if(cs!=minis){
					$(".mini").html();
					setmini();
					init();
					
					//$(".mini").html(cthis.html())
				}
