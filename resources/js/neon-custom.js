 ...
 **/
 ...
 ;(function($, window, undefined){
 	...
 	"use strict";
 	var oTable = "";
 	function validate_email(tag){
 		var emailReg = new RegExp(/^(("[\w-\s]+")|([\w-]+(?:\.[\w-]+)*)|("[\w-\s]+")([\w-]+(?:\.[\w-]+)*))(@((?:[\w-]+\.)*\w[\w-]{0,66})\.([a-z]{2,6}(?:\.[a-z]{2})?)$)|(@\[?((25[0-5]\.|2[0-4][0-9]\.|1[0-9]{2}\.|[0-9]{1,2}\.))((25[0-5]|2[0-4][0-9]|1[0-9]{2}|[0-9]{1,2})\.){2}(25[0-5]|2[0-4][0-9]|1[0-9]{2}|[0-9]{1,2})\]?$)/i);
 		var valid = emailReg.test(tag);
 		if(!valid) {
 			$("#invalid_email_label").show();
 			return false;
 		} else {
 			$("#display_invited_cont").show();
 			$("#invalid_email_label").hide();
	    	//jQuery(".invite_email_tagmanage").tagsManager('pushTag',tag);
	    	return true;
	    }
	}
	...
	$(document).ready(function()
	{
       ...
       /* $('.invite_email_tagmanage').tagsInput({
            width: 240,
			defaultText:'Add Emails',
			autocomplete_url:siteUrl+"notification_emails/get",
...
jQuery(".invite_email_tagmanage").on('blur',function(){
	if($(this).val() != "")
	{
		var tag = $(this).val();
		jQuery(".invite_email_tagmanage").tagsManager('pushTag',tag)
...
jQuery("#form_invite").on('submit',function(){
	var tag = jQuery(".invite_email_tagmanage").val();
	jQuery(".invite_email_tagmanage").tagsManager('pushTag',tag);
	if(!$("#invalid_email_label").is(":visible")){
		return true;
	}
	return false;
});
...
$this.validate(opts);
		...
		var user_tbl = $('#table-2');
		if(user_tbl.length > 0) {
			var oTable = $('#table-2').dataTable( {
				
				"bServerSide": true,
				"sAjaxSource": site_url+'admin/user/datatable',
				"bJQueryUI": true,
				...
				"fnInitComplete": function() {
					...
					"fnDrawCallback": function ( oSettings ) {
						...
						$('.make-switch').on('switch-change', function (e, data) {
							...
							if(data.value){status='y';}
							$.ajax({
								url:site_url+"admin/user/chng_status",
								type:"POST",
		...
		var role_tbl = $('#table-3');
		if(role_tbl.length > 0) {
			var roleTable = $('#table-3').dataTable( {
				
				"bServerSide": true,
				"sAjaxSource": site_url+'admin/roles/datatable',
				"bJQueryUI": true,
				"sPaginationType": "bootstrap",
				"iDisplayStart ":20,  
				"fnInitComplete": function() {
					...
					"fnDrawCallback": function ( oSettings ) {
						...
						$('.make-switch').on('switch-change', function (e, data) {
							var role_status='n';
							var roleid = $(this).attr("data-uid");
							var actn = $(this).attr("data-col");

							if(data.value){role_status='y';}
							$.ajax({
								url:site_url+"admin/roles/chng_status",
								type:"POST",
								data:{roleid:roleid,status:role_status,action:actn}
							})
...
var genre_tbl = $('#table-genre');
if(genre_tbl.length > 0) {
	var genreTable = $('#table-genre').dataTable( {

		"bServerSide": true,
		"sAjaxSource": site_url+'admin/genre/datatable',
		"bJQueryUI": true,
		"sPaginationType": "bootstrap",
		"iDisplayStart ":20,  
		"fnInitComplete": function() {
					...
					"fnDrawCallback": function ( oSettings ) {
						...
						$('.make-switch').on('switch-change', function (e, data) {
							var genre_status='n';
							var genreid = $(this).attr("data-uid");
							if(data.value){genre_status='y';}
							$.ajax({
								url:site_url+"admin/genre/chng_status",
								type:"POST",
								data:{genreid:genreid,status:genre_status}
							})
...
/*Content module*/
var content_tbl = $('#table-content');
if(content_tbl.length > 0) {
	var genreTable = content_tbl.dataTable( {

		"bServerSide": true,
		"sAjaxSource": site_url+'admin/content/datatable',
		"bJQueryUI": true,
		"sPaginationType": "bootstrap",
		"iDisplayStart ":20,  
		"fnInitComplete": function() {
					...
					"fnDrawCallback": function ( oSettings ) {
						...
						$('.make-switch').on('switch-change', function (e, data) {
							var content_status='n';
							var contentid = $(this).attr("data-uid");
							if(data.value){content_status='y';}
							$.ajax({
								url:site_url+"admin/content/chng_status",
								type:"POST",
								data:{contentid:contentid,status:content_status}
							})
...
var invitation_tbl = $('#table-invitation');
if(invitation_tbl.length > 0) {

	var genreTable = invitation_tbl.dataTable( {

		"bServerSide": true,
		"sAjaxSource": site_url+'admin/invitation/datatable',
		"bJQueryUI": true,
		"sPaginationType": "bootstrap",
		"iDisplayStart ":20,  
		"fnInitComplete": function() {
					...
					"fnDrawCallback": function ( oSettings ) {
						...
						$('.make-switch').on('switch-change', function (e, data) {
							var content_status='n';
							var invitationid = $(this).attr("data-uid");
							if(data.value){content_status='y';}
							$.ajax({
								url:site_url+"admin/invitation/chng_status",
								type:"POST",
								data:{invitationid:invitationid,status:content_status}
							})
...
/*invitation module ends*/

/*invite code module*/
var invite_tbl = $('#table-invite');
if(invite_tbl.length > 0) {

	var genreTable = invite_tbl.dataTable( {

		"bServerSide": true,
		"sAjaxSource": site_url+'admin/invite/datatable',
		"bJQueryUI": true,
		"sPaginationType": "bootstrap",
		"iDisplayStart ":20,  
		"fnInitComplete": function() {
...
/*Articles code module starts*/
var invite_tbl = $('#table-article');
if(invite_tbl.length > 0) {

	var genreTable = invite_tbl.dataTable( {

		"bServerSide": true,
		"sAjaxSource": site_url+'admin/article/datatable',
		"bJQueryUI": true,
		"sPaginationType": "bootstrap",
		"iDisplayStart ":20,  
		"fnInitComplete": function() {
					...
					"fnDrawCallback": function ( oSettings ) {
						...
						$('.make-switch').on('switch-change', function (e, data) {
							var content_status='n';
							var articleid = $(this).attr("data-uid");
							var actn = $(this).attr("data-col");
							if(data.value){content_status='y';}
							$.ajax({
								url:site_url+"admin/article/chng_status",
								type:"POST",
								data:{articleid:articleid,status:content_status,actn:actn}
							})
...
/*Articles module ends*/


/*Tracks code module starts*/
var tracks_tbl = $('#table-tracks');
if(tracks_tbl.length > 0) {

	var genreTable = tracks_tbl.dataTable({

		"bServerSide": true,
		"sAjaxSource": site_url+'admin/tracks/datatable',
		"bJQueryUI": true,
		"sPaginationType": "bootstrap",
		"iDisplayStart ":20,  
		"fnInitComplete": function() {
					...
					"fnDrawCallback": function ( oSettings ) {
						...
						$('.make-switch').on('switch-change', function (e, data) {
							var content_status='n';
							var trackid = $(this).attr("data-uid");
							if(data.value){content_status='y';}
							$.ajax({
								url:site_url+"admin/tracks/chng_status",
								type:"POST",
								data:{trackid:trackid,status:content_status}
							})
						});
					}					
				});
}
/*Tracks code module ends*/

/*Surveys code module starts*/
var survey_tbl = $('#table-surveys');
if(survey_tbl.length > 0) {

	var genreTable = survey_tbl.dataTable({

		"bServerSide": true,
		"sAjaxSource": site_url+'admin/surveys/datatable',
		"bJQueryUI": true,
		"sPaginationType": "bootstrap",
		"iDisplayStart ":20,  
		"fnInitComplete": function() {
					...
					"fnDrawCallback": function ( oSettings ) {
						...
						$('.make-switch').on('switch-change', function (e, data) {
							var content_status='n';
							var surveyid = $(this).attr("data-uid");
							var actn = $(this).attr("data-col");
							if(data.value){content_status='y';}
							$.ajax({
								url:site_url+"admin/surveys/chng_status",
								type:"POST",
								data:{surveyid:surveyid,status:content_status,actn:actn}
							})
...
/*Notification code module starts*/
var notification_tbl = $('#table-notification');
if(notification_tbl.length > 0) {
	var genreTable = notification_tbl.dataTable({
		"bServerSide": true,
		"sAjaxSource": site_url+'admin/notification/datatable',
		"bJQueryUI": true,
		"sPaginationType": "bootstrap",
		"iDisplayStart ":20,  
		"fnInitComplete": function() {
					...
					"fnDrawCallback": function ( oSettings ) {
						...
						$('.make-switch').on('switch-change', function (e, data) {
							var content_status='n';
							var nid = $(this).attr("data-uid");
							var actn = $(this).attr("data-col");
							if(data.value){content_status='y';}
							$.ajax({
								url:site_url+"admin/notification/chng_status",
								type:"POST",
								data:{nid:nid,status:content_status,actn:actn}
							})
...
/*Memership code module starts*/
var membership_tbl = $('#table-membership');
if(membership_tbl.length > 0) {

	var membershipTable = membership_tbl.dataTable({

		"bServerSide": true,
		"sAjaxSource": site_url+'admin/membership/datatable',
		"bJQueryUI": true,
		"sPaginationType": "bootstrap",
		"iDisplayStart ":20,  
		"fnInitComplete": function() {
					...
					"fnDrawCallback": function ( oSettings ) {
						...
						$('.make-switch').on('switch-change', function (e, data) {
							...
							if(data.value){content_status='y';}
							$.ajax({
								url:site_url+"admin/membership/chng_status",
								type:"POST",
								data:{surveyid:surveyid,status:content_status,actn:actn}
							})
...
/*Memership module ends*/


/*Memership coupons module starts*/
var membership_tbl = $('#table-membership_coupons');
if(membership_tbl.length > 0) {

	var membershipTable = membership_tbl.dataTable({

		"bServerSide": true,
		"sAjaxSource": site_url+'admin/membership_coupons/datatable',
		"bJQueryUI": true,
		"sPaginationType": "bootstrap",
		"iDisplayStart ":20,  
		"fnInitComplete": function() {
					...
					"fnDrawCallback": function ( oSettings ) {
						...
						$('.make-switch').on('switch-change', function (e, data) {
							var content_status='n';
							var couponid = $(this).attr("data-uid");
							var actn = $(this).attr("data-col");
							if(data.value){content_status='y';}
							$.ajax({
								url:site_url+"admin/membership_coupons/chng_status",
								type:"POST",
								data:{couponid:couponid,status:content_status,actn:actn}
							})
...
$("body").on('change','.type_radio',function(){
	var value = $(this).val();
	if(value == "p")
...
/*Memership coupons ends here*/



/*Send gift coupons*/

var send_gift_coupon_tbl = $('#table-send_gift_coupon');
if(send_gift_coupon_tbl.length > 0) {
	var sendgiftcouponTable = send_gift_coupon_tbl.dataTable({
		"bServerSide": true,
		"sAjaxSource": site_url+'admin/send_gift_coupon/datatable',
		"bJQueryUI": true,
		"sPaginationType": "bootstrap",
		"iDisplayStart ":20,  
		"fnInitComplete": function() {
					...
					"fnDrawCallback": function ( oSettings ) {
						...
						$('.make-switch').on('switch-change', function (e, data) {
							...
							if(data.value){content_status='y';}
							$.ajax({
								url:site_url+"admin/send_gift_coupon/chng_status",
								type:"POST",
								data:{couponid:couponid,status:content_status,actn:actn}
							})
						});
...
var mood_tbl = $('#table-mood');
if(mood_tbl.length > 0) {
	var moodTable = $('#table-mood').dataTable( {

		"bServerSide": true,
		"sAjaxSource": site_url+'admin/mood/datatable',
		"bJQueryUI": true,
		"sPaginationType": "bootstrap",
		"iDisplayStart ":20,  
		"fnInitComplete": function() {
					...
					"fnDrawCallback": function ( oSettings ) {
						...
						$('.make-switch').on('switch-change', function (e, data) {
							var genre_status='n';
							var moodid = $(this).attr("data-uid");
							if(data.value){genre_status='y';}
							$.ajax({
								url:site_url+"admin/mood/chng_status",
								type:"POST",
								data:{genreid:genreid,status:genre_status}
							})
...
var admin_tbl = $('#table-4');
if(admin_tbl.length > 0) {
	var roleTable = $('#table-4').dataTable( {

		"bServerSide": true,
		"sAjaxSource": site_url+'admin/sub_admin/datatable',
		"bJQueryUI": true,
		"sPaginationType": "bootstrap",
		"iDisplayStart ":20,  
		"fnInitComplete": function() {
					...
					"fnDrawCallback": function ( oSettings ) {
						...
						$('.make-switch').on('switch-change', function (e, data) {
							...
							$.ajax({
								url:site_url+"admin/sub_admin/chng_status",
								type:"POST",
								data:{uid:roleid,status:role_status}
							})
