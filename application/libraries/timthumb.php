...
class timthumb {    
    ...
    public function start($temp = NULL){        
        //$tim = new timthumb();
        $this->init();
        $this->handleErrors();
        $this->securityChecks();
    ...
    public function init(){
        ...
        if($this->isURL){
            $arr = explode('&', http_build_query($_GET));
            asort($arr);
            ...
            /*print_r($_SERVER);*/
             $this->cachefile = $this->cacheDirectory . '/' . FILE_CACHE_PREFIX . $cachePrefix . md5($this->salt . $this->localImageMTime . http_build_query($_GET) . $this->fileCacheVersion) . FILE_CACHE_SUFFIX;
        }
    ...
    public function tryBrowserCache(){
    ...
    public function tryServerCache(){
    ...
    public function serveInternalImage(){
    ...
    public function processImageAndWriteToCache($localImage){
    ...
    public function getLocalImagePath($src){
        $src = str_replace("\\","/", $src);
    ...
    public function toDelete($name){
        $this->debug(3, "Scheduling file $name to delete on destruct.");
        $this->toDeletes[] = $name;
    }
    public function serveWebshot(){
    ...
    public function serveExternalImage(){
    ...
    public function serveCacheFile(){
    ...
    public function sendImageHeaders($mimeType, $dataSize){
    ...
    public function sanityFail($msg){
