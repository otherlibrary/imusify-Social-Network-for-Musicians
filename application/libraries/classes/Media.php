...
class Media
{
    ...
    static function mediaYoutube($url)
    {
        ...
        $final_media=array();
        $final_media['image']=$media[0];
        $final_media['iframe']=$media[1];
        $final_media['type']='video';
        return $final_media;
    }
    ...
    /** Return iframe code for Soundcloud */
    static function mediaSoundcloud($url)
    {
        ...
        if ($url != "") {
            array_push($media, str_replace('height="400"', 'height="140"', $jsonObj->html));
        } else {
            array_push($media, "", "");
        }
       /* echo "<pre>";
        ...
        $final_media=array();
        $final_media['image']='';
        $final_media['type']='audio';
        $final_media['iframe']=$media[0];
        return $final_media;
