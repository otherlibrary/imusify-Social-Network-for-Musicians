...
Class commonfn extends CI_Model
{
    ...
    function get_licence_types($cond = null,
                               $limit = null,
                               $start_limit = null,
                               $flag = false,
                               $trackId = 0,
    ...
    function get_permalink($title, $table, $dbcolumn, $orderby = null, $cond = null)
    {
        ...
        if (!empty($row)) {
            ...
            if ($temps == $title) {
                ...
                $slug_title = $this->slug->url_slug($title, [
                    'delimiter' => '_',
                ]);
    ...
    function get_countries($cond = null, $limit = null, $start_limit = null)
    {
        ...
        $this->db->select('location_id as value,label');
