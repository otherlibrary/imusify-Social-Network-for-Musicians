...
Class browse_recommended extends CI_Model
{
	...
	function fetch_popular_tracks($condition = NULL,$limit = NULL,$orderby = NULL,$counter = NULL,$start_limit = NULL,$user_id = NULL)
	{
...
//                  FROM tracks as tt,genre as g,users as u ".$cond." ".$orderby." ".$limit." "); 
	...
	function fetch_new_tracks($condition = NULL,$limit = NULL,$orderby = NULL,$counter = NULL,$start_limit = NULL,$width = NULL,$height = NULL,$images_only = NULL,$userId = NULL,$uwidth = NULL,$uheight = NULL)
	{
		$userId = ($userId != NULL) ? $userId : $this->sess_userid;
		$this->load->model('commonfn');
		$output = array();
	...
	function fetch_instrumental($condition = NULL,$limit = NULL,$orderby = NULL,$counter = NULL,$start_limit = NULL,$width = NULL,$height = NULL,$userId = NULL,$uwidth = NULL,$uheight = NULL)
	{
		$this->load->model('commonfn');
		$userId = ($userId != NULL) ? $userId : $this->sess_userid;
