...
<div class="table-toolbar">
	<div class="row">
		...
		<div class="col-md-6">
			<div class="btn-group pull-right">
				<div class="btn-group">
					<a href="<?php print base_url(); ?>admin/invitation/add" class="btn btn-primary">
	...
	<div id="table-3_wrapper" class="dataTables_wrapper form-inline" role="grid">
		<table class="table table-bordered datatable dataTable" id="table-invitation" aria-describedby="table-3_info">
			<thead>
				<tr role="row">
