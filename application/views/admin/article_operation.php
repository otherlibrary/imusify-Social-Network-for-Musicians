<ol class="breadcrumb bc-3">
	...
	<li class="active">
		<strong><?php print $action ?> Article</strong>
	</li>
</ol>
<h2><?php print $action ?> Article</h2>
<br />
	...
	<div class="col-md-12">
		...
		<div class="panel panel-primary" data-collapsed="0">
			<div class="panel-body">
				...
				<div class="form-group">
					<label for="genre" class="col-sm-3 control-label">Article Image</label>
					<div class="col-sm-9">
						<input type="button" id="article_image" class="btn btn-info" name="article_image" value="Select Image">
						<input type="hidden" value="" name="randomnumber" id="randomnumber">
						<div id="article_image_modal" style="height:300px;width:800px;display:none;position:relative;"></div>
					</div>
				</div>
