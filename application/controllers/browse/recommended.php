...
class recommended extends MY_Controller {
	...
	function index($action = "",$page = NULL)
	{
		...
		//dump($data_array);		
		$p[]=array("song_cover_image"=>img_url()."song-cover-img.png","pl_name"=>"Unknown","pl_songs" => "150","pl_followers"=>"150","pl_likes"=> "250");
				
		/*recently_listened*/
		$rl[]=array("tab_image"=>img_url()."vedio-img1.jpg","tab_name" => "abc","tab_waveform" => img_url()."small-wave-img.png");
