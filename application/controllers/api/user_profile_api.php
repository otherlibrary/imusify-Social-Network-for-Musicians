...
class User_profile_Api extends REST_Controller
{
    ...
    function user_roles_post()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            //empty role
            $user_roles_response = $this->user_profile->insert_roles([]);
    ...
    function update_profile_post()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            if ($user) {
                ...
                $this->response(['error' => 'Please try again.Profile not edited successfully.'], 404);
            }
    ...
    function invite_friends_post()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            if ($user) {
                ...
                $this->response(['error' => 'Please try again.'], 404);
            }
