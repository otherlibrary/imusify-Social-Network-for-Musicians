    ...
    function save_track_db_post()
    {
        ...
        */
        if ($this->form_validation->run() == FALSE) {
            $this->response(['error' => lang('error_signup_val_required')], 400);
        } else {
            ...
            $track = $this->uploadm->insert_track(
                $this->post('title'),
                $this->post('desc'),
                $this->post('mm'),
                $this->post('dd'),
