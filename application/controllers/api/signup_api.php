    ...
    function signup_post()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            if ($user > 0) {
                ...
                $this->response(['error' => 'You are either not invited yet or invitation code incorrect.Please request admin for signup.'], 404);
            } else {
                $this->response(['error' => 'Please try again.Signup unsuccessful.'], 404);
            }
        }
    }
